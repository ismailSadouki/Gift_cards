                        ...
                        @auth
                            <li class="nav-item">
                              <a href="{{route('order.view')}}" class="nav-link">
                                @if (Auth::user()->ordersInCart()->count() > 0 )
                                    <span class="badge badge-warning">{{Auth::user()->ordersInCart()->count()}}</span>
                                @endif
                                Cart
                            ...
                            <li class="nav-item">
                                <a href="{{route('purchases.index')}}" class="nav-link">
                                  @if (Auth::user()->purchasesInCart()->count() > 0 )
                                      <span class="badge badge-warning">{{Auth::user()->purchasesInCart()->count()}}</span>
                                  @endif
                                  purchases
                                ...
                                <div class="dropdown-menu dropdown-menu-left px-2 text-right mt-2" aria-labelledby="navbarDropdown">
                                    ...
                                    <div class="pt-4 pb-1 border-t border-gray-200">
                                        ...
                                        <div class="mt-3 space-y-1">
                                            ...
                                            @if(auth()->user()->adminstration_level === 1 or  auth()->user()->adminstration_level === 2)
                                            <x-jet-responsive-nav-link href="{{route('admin.index')}}" :active="request()->routeIs('profile.show')" class="dropdown-item">
                                                {{ __('لوحة التحكم') }}
                                            </x-jet-responsive-nav-link>
                                            @endif
